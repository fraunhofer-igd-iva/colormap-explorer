 ...
 * @author Simon Thum
 */
public class ColorDynamicCappedWhiteContrast extends ColorDynamic
{
	/**
	 * @param sampling the sampling strategy to use
	 */
	public ColorDynamicCappedWhiteContrast(SamplingStrategy sampling)
	{
		super(sampling);
	}
	...
	{
		return "Contrast to white (capped at 3)";
	}
}
